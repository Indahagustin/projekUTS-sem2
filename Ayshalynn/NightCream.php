				...
				<div class="col-lg-6">
					<div class="s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/category/s-p6.png" alt="">
						</div>
						<div class="single-prd-item">
							<img class="img-fluid" src="img/category/s-p6.png" alt="">
						</div>
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<ul class="list">
							...
							<li><a href="#"><span>Stok</span> : 50</a></li>
						</ul>
						<p>Beauty Night Cream perawatan kulit pada malam hari, melembabkan kulit, Vitamin C membantu mencerahkan kulit juga kandungan aktif lainnya menjadikan kulit tetap sehat. </p>
