			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="img/category/s-p8.png" alt="">
						</div>
						<div class="single-prd-item">
							<img class="img-fluid" src="img/category/s-p8.png" alt="">
						</div>
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<h2>Rp7.500</h2>
						<ul class="list">
							<li><a class="active" href="#"><span>Kategori</span> : Minuman</a></li>
							<li><a href="#"><span>Stok</span> : 15</a></li>
						</ul>
						<p>Mizone adalah pilihan yang tepat untuk mengembalikan cairan tubuh kamu
							yang hilang akibat olahraga dan membantu pembentukan energi.</p>
